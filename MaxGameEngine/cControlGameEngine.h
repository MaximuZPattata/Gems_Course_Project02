...
public:
    ...
    void CreateVerletSoftBody(std::string modelName, glm::vec3 softbodyAcceleration, bool createDebugSpheres, std::string debugModelName, 
    ...
    void ApplyConstantPositionToSoftBody(std::string modelName, glm::vec3 constantPosition);
