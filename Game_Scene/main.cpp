...
int main()
{
    ...
    for (int count = 1; count <= TOTAL_COUNT; count++)
    {
        ...
        gameEngine.CreateVerletSoftBody(modelName, glm::vec3(0.0f, -15.0f, 0.0f), createDebugSpheres, debugModelName, 0.25f, glm::vec4(0.1, 0.1, 0.1, 1.0), createSoftBodyThreads);
